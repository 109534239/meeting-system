...
                    await UpdateLanguageProficiency(trackedResume.Id, model.LanguageSkills);
                    ...
                    await UpdatePortfolios(trackedResume.Id, PortfolioTitleList, PortfolioDescList, PortfolioLinkList, portfolioFilesByRow, PortfolioExistingFileList);
            ...
            for (int i = 0; i < rowCount; i++)
            {
                ...
                if (hasNewFiles)
                {
                    ...
                    foreach (var uploadFile in uploadFiles)
                    {
                        ...
                        savedPaths.Add($"/uploads/portfolio/{newFileName}");
                    }
